...
{
    public static async Task<int> PreviousInventoryAsync(int id, StoreFront store, string _connectionString)
    {
    ...
    public static async Task AddInventoryAsync(Product product, StoreFront store, string _connectionString)
    {
    ...
    public static async Task<List<Product>> GetInventoryAsync(StoreFront store, string _connectionString)
    {
        return await Task.Factory.StartNew(() =>
        {
            DataSet inventorySet = new DataSet();
    ...
    public static async Task<int> GetInventoryIDAsync(Product product, StoreFront store, string _connectionString)
    {
        return await Task.Factory.StartNew(() =>
        {
            DataSet inventorySet = new DataSet();
    ...
    public static async Task UpdateInventoryAsync(Product product, StoreFront store, string _connectionString)
    {
        await Task.Factory.StartNew(() =>
        {
            DataSet inventorySet = new DataSet();
