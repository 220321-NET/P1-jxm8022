...
{
    public static async Task AddStoreAsync(StoreFront store, string _connectionString)
    {
    ...
    public static async Task<StoreFront> GetStoreAsync(string city, string _connectionString)
    {
    ...
    public static async Task<List<StoreFront>> GetStoreFrontsAsync(string _connectionString)
    {
        return await Task.Factory.StartNew(() =>
        {
